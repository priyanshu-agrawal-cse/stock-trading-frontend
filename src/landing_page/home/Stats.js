...
function Stats() {
    ...
    <div className=''>
        ...
        <div className='row '>
            <div className='p-5 col-lg-6 sm-col-12 '>
                <div style={{width:"100%"}}>
                ...
                <h2 className='fs-4'>No spam or gimmicks
                </h2>
            ...
            <div className='p-5 col-lg-6 sm-col-12'>
                <img src='media/images/ecosystem.png' style={{width:"30rem"}} />
                <div className='text-center '>
                    <a href='' className='mx-3' style={{textDecoration :"none"}}>Explore our products <i class="fa-solid fa-arrow-right"></i></a>
                    <a href='' className='mx-3' style={{textDecoration :"none"}}>Try kit demo <i class="fa-solid fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
       </div>
