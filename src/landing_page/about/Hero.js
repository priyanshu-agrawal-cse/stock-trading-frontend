    ...
    return (
        ...
        <div className=''>
            ...
            <div className='row p-5 mt-5 mb-5'>
                <h1 className='text-center fs-2'>We pioneered the discount broking model in India.<br></br>
            ...
            <div className='row p-5 mt-5 border-top text-muted ' style={{lineHeight:"1.8rem" , fontSize:"1.2rem"}}>
                ...
                <p>In addition, we run a number of popular open online educational and community initiatives to empower retail traders and investors.</p>
                    ...
                    <p>And yet, we are always up to something new every day. Catch up on the latest updates on our blog or see what the media is <Link to="/about" style={{textDecoration:"none"}} >saying about us.</Link> </p>
